...
因此对我来说，这门课程的学习基本上就是看书。我们的教材是 John E. Hopcroft（就是 Hopcroft-Karp 那个人）的 *Introduction to Automata Theory, Languages, and Computation* ，虽然废话很多（真的多，多出声），但换个角度讲也可以说是讲的非常详细，还是能看懂并且能学到东西的。不过我在网上查到这本书的评价并不怎么好。

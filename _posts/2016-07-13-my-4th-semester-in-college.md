...
![数电实验的实验箱](/assets/images{{ page.id }}/1-digital-circuit-exp-set.jpg)
...
![日本旅行](/assets/images{{ page.id }}/2-japan-trip-collage.jpg)
...
![台湾旅行](/assets/images{{ page.id }}/3-taiwan-trip-collage.jpg)
